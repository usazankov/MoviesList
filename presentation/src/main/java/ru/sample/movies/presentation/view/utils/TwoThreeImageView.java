...
import static ru.sample.movies.presentation.view.utils.Constant.THREE;
import static ru.sample.movies.presentation.view.utils.Constant.TWO;
...
public class TwoThreeImageView extends AppCompatImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int twoThreeHeight = View.MeasureSpec.getSize(widthMeasureSpec) * THREE / TWO;
